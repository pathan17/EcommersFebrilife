...
import AdCart from "../HomeComponent/AdCart";
import ClickFromButton from "../HomeComponent/ClickFromButton";
    ...
    return (
        <div>
            <div className="main mt-5 ">
                <div className="container mx-auto flex flex-col md:flex-row md:gap-0 md:justify-center  gap-1 lg:gap-[40px] lg:max-w-[1120px] relative">
