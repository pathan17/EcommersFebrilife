            ...
            <div className="main-shop md:px-[40px] px-4 sm:mt-2 bg-slate-100 h-[75px] lg:h-[60px] md:h-[100px] sm:mb-[100px]  lg:mt-[-28px]">
                <div className="container mx-auto">
                    <div className="Shop flex flex-col sm:flex-col lg:flex-row gap-3 lg:gap-[60px]">
                        ...
                        <div className="shopNow w-full lg:w-[30%] md:w-[70%] sm:mx-auto bg-slate-100   lg:p-0 lg:bg-inherit hover:text-red-600 ">
                            <div className="Icon flex flex-col sm:flex-row gap-2 md:gap-0  sm:gap-1 lg:gap-5   justify-center items-center  lg:mt-[12px]  md:mt-[-10px]">
                                <div className="text">
