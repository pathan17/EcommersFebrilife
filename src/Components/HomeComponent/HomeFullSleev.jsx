...
const HomeFullSleev = () => {
  ...
  return (
    <div>
      <div className="mb-5 md:px-[40px] lg:px-[9px] mt-5 lg:mt-10  container mx-auto lg:max-w-[1120px]">
        <div>
          <div className="flex flex-col lg:flex-row gap-5 p-5 lg:p-0">
            ...
            <div className="w-full lg:w-2/3 flex flex-wrap  gap-4 lg:gap-3  ">
            {FullSleevImg.map((item, i) => (
              <Link to="/Price" key={i} className="w-1/2 sm:w-[48%] md:w-[49%] lg:w-[23%] mx-auto relative">
                ...
                <div className=" absolute price bottom-[-6px] ">
                  <Link to="/Price">
                    <h1 className="text-black bg-white px-[30px] py-[2px] lg:ml-[30px] ml-[40px] rounded-md shadow-lg">
                      ৳1000
                    </h1>
